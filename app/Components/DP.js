    ...
    <div className=" w-full h-full flex items-end justify-center pb-0">
      ...
      <div className="relative w-full max-w-[700px] aspect-square">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="w-[90%] h-[90%] bg-gradient-to-r from-purple-500 via-violet-500 to-pink-500 rounded-[40%_60%_70%_30%/40%_50%_60%_50%] opacity-80 animate-pulse" />
        </div>

        {/* Web Developer Label - Behind image, top left */}
        <div className="absolute top-[5%] left-[5%] z-0 sm:top-[0%] sm:left-[2%] lg:top-[-10%] lg:left-[10%]">
        ...
        <div className="relative z-10 w-full h-full flex items-end justify-center">
          <Image
            ...
            width={700}
            height={700}
            className="w-[85%] h-auto object-contain sm:w-[90%] md:w-full"
            priority
          />
        </div>

        {/* Mobile Developer Label - In front of image, bottom right */}
        <div className="absolute bottom-[8%] right-[-5%] z-20 sm:bottom-[12%] sm:right-[0%] md:bottom-[10%] md:right-[-2%]">
          <div className="relative">
            {/* Main label */}
