 ...
 * URL instead of "zubyr.dev". `alternateName` names the forms that are *not*
 * the preferred one, the bare domain included, which is how you tell Google
 * which of the names it has seen is the label and which are the aliases.
 */
  ...
  return {
    ...
    "@graph": [
      ...
      },
      {
        ...
        "@id": PROFILEPAGE_ID,
        url: site.url,
        // The same lockup, with the same separator, as the homepage <title>.
        name: site.title,
        about: { "@id": PERSON_ID },
