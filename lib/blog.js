...
/**
 * Slug plus the date the sitemap should report as `lastmod`. Same contract as
 * getPublishedProjectEntries(): `updatedAt || publishedAt`, from frontmatter.
 */
export function getPublishedPostEntries() {
  return getAllPosts()
    .filter(isPublished)
