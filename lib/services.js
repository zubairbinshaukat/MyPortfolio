...
export const services = [
  {
    slug: "gohighlevel",
    /** Short — this is the sitelink label, the card heading and the breadcrumb. */
    title: "GoHighLevel Development",
    /**
     * The `<title>` tag, and only that. It is written out in full rather than
     * assembled from `title` because two of the four need different words in a
     * search result than on the page — "Mobile App Development" is a clear
     * label in a nav and an ambiguous one in a SERP. It is used as an absolute
     * title: the brand is already in the string.
     */
    metaTitle: "GoHighLevel Development - Zubair Bin Shaukat",
...

  {
    ...
    metaTitle: "n8n & Workflow Automation - Zubair Bin Shaukat",
...

  {
    ...
    metaTitle: "Next.js Web Development - Zubair Bin Shaukat",
...

  {
    ...
    metaTitle: "React Native Mobile App Development - Zubair Bin Shaukat",
